function out = env(noiseFlag)
    ...
    out.rho_bias = min(max(randn(1,1)*0.1, -0.2), 0.3) * noiseFlag;  % [-]
    % Atmospheric density noise variance:
    out.rho_var  = 0.025^2 * noiseFlag;           % [-]
